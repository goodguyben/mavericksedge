...
export default function WebServices() {
  ...
  return (
    <div>
      <SEOHead 
        title="Mavericks Edge | Edmonton Web Design and Development"
        description="Professional Edmonton web design and development. Build responsive, SEO-optimized websites that drive results and help your business grow. Free quote today!"
        ...
        ogTitle="Mavericks Edge | Edmonton Web Design and Development"
        ogDescription="Affordable Edmonton web design and development for businesses that want to stand out online. Fast, responsive, and SEO-optimized websites that convert visitors into customers."
