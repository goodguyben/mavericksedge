...
export default function WebServicesCalgary() {
  ...
  const faqItems = [
    {
      ...
      answer: "Our Calgary web design services start at $850 for basic business websites and range up to $10,000+ for complex e-commerce and custom applications. We provide transparent pricing and free consultations to discuss your specific needs and budget."
    },
    {
      question: "How long does it take to build a website in Calgary?",
      answer: "Most Calgary business websites take 4-8 weeks from start to finish. Simple brochure sites can be completed in 2-3 weeks, while complex e-commerce or custom applications may take 8-12 weeks. We provide detailed timelines during our discovery phase."
    },
    {
      question: "Do you provide website hosting for Calgary businesses?",
      answer: "Yes, we offer Canadian web hosting specifically optimized for Alberta businesses. Our hosting includes SSL certificates, daily backups, security monitoring, and 24/7 Calgary-based support. Plans start at $25/month."
    },
    {
      question: "Can you help with SEO for my Calgary business website?",
      answer: "Absolutely! All our websites include basic SEO optimization with Calgary and Alberta keyword targeting. We also offer comprehensive SEO services including local optimization, Google My Business management, and ongoing search marketing."
    },
    {
      question: "Do you redesign existing websites for Calgary businesses?",
    ...
    {
      question: "What makes your Calgary web design different from competitors?",
      answer: "Our deep understanding of the Calgary and Alberta business landscape, combined with cutting-edge design and development practices, sets us apart. We focus on local SEO, mobile optimization, and conversion-driven design that gets results."
    }
  ];
  ...
  return (
    <div>
      <SEOHead 
        title="Mavericks Edge | Calgary Web Design and Development"
        description="Professional Calgary web design and development. Build responsive, SEO-optimized websites that drive results and help your business grow. Free quote today!"
        ...
        ogTitle="Mavericks Edge | Calgary Web Design and Development"
        ogDescription="Affordable Calgary web design and development for businesses that want to stand out online. Fast, responsive, and SEO-optimized websites that convert visitors into customers."
