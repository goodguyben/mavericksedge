...
import WebServicesCascadeSection from "@/components/sections/WebServicesCascadeSectionCalgary";
import ScrollFadeSection from '@/components/ui/scroll-fade-section';
import { LazySection } from '@/components/performance/LazySection';
import GoogleReviews from '@/components/GoogleReviewsCalgary';
...
export default function WebServicesCalgary() {
  ...
  const breadcrumbs = [
    ...
    { name: "Web Development", url: "https://mavericksedge.ca/web-design-services-calgary" }
  ];
  ...
  const coreServices = [
    {
      ...
      description: "Calgary businesses demand excellence. We build corporate-grade websites without the downtown agency price tag or the 6-month timeline.",
    ...
    },
    {
      ...
      description: "From Beltline boutiques to industrial suppliers, we build Shopify stores that handle complex inventories and high transaction volumes.",
    ...
    },
    {
      ...
      description: "Automate your operations. We build custom portals, dashboards, and SaaS products for Calgary's energy, tech, and service sectors.",
  ...
  const specializedServices = [
    ...
    },
    {
      ...
      description: "Dominate the local market. We map your site to how Calgary actually searches, from 'downtown lawyers' to 'SE industrial supply'.",
      technologies: ["Technical SEO", "Local Schema", "Core Web Vitals", "Calgary Keywords"]
    },
    {
  ...
  const webAppTiles = [
    ...
    },
    {
      ...
      blurb:
        "Search‑ready from day one. Technical SEO, structured data, and Core Web Vitals tuned for real‑world devices and Calgary search intent.",
      media: "https://mavericksedge.ca/videos/Portfolio_Video_27.webm",
      points: [
        "Calgary‑relevant keyword mapping and titles",
  ...
  const faqItems = [
    {
      question: "How much does web design cost in Calgary?",
      answer: "Calgary agencies often charge $15k+ for a basic site. We don't. Our professional sites start at $1,200. You pay for the code and the design, not our office rent in The Bow."
    },
    {
      question: "Do you meet with clients in Calgary?",
      answer: "Yes. We're happy to meet for coffee in Kensington, the Beltline, or at your office. We believe in face-to-face relationships."
    },
    {
      question: "Why shouldn't I just use Wix or Squarespace?",
      answer: "For a hobby, they're fine. For a business in a competitive market like Calgary, they're a liability. You need a site that loads instantly and ranks on Google. That requires custom code."
    },
    {
      question: "How do I rank higher than my competitors?",
      answer: "Calgary is competitive. To win, you need technical perfection and local relevance. We use advanced schema markup to tell Google exactly what you do and where you serve."
    },
    {
      question: "Can you fix my existing slow website?",
      answer: "Yes. We'll audit it. If the code is salvageable, we'll optimize it. If it's a bloated WordPress theme, we might recommend a rebuild for better long-term ROI."
    },
    {
      question: "What's your support like after launch?",
      answer: "We offer dedicated support plans. You get a direct line to a developer, daily backups, and security monitoring. We keep your digital assets safe."
    }
  ];
  ...
  const localSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "Mavericks Edge Web Design Calgary",
    ...
    "url": "https://mavericksedge.ca/web-design-services-calgary",
    "sameAs": [
  ...
  return (
    <div>
      <SEOHead
        title="Calgary Web Design | Corporate Grade Sites, Fair Prices"
        description="Stop overpaying for web design. We build high-performance, custom websites for Calgary businesses that demand results. Get a free consultation."
        keywords="Calgary website design, website design Calgary, Calgary web design, web development Calgary, Calgary websites"
        canonicalUrl="https://mavericksedge.ca/web-design-services-calgary"
        ogTitle="Calgary Web Design | Corporate Grade Sites, Fair Prices"
        ogDescription="Stop overpaying for web design. We build high-performance, custom websites for Calgary businesses that demand results. Get a free consultation."
                ...
                <div className="relative z-10 px-0">
                  ...
                  >
                    <span className="block text-3xl sm:text-4xl md:text-5xl bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                      Calgary Web Design & Development
                    </span>
                  ...
                  >
                    Calgary is competitive. Your website is your first impression. We build sites that look expensive but are priced for growth.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    ...
                    <div className="hidden md:flex items-center gap-6 text-sm text-[#AAAAAA]">
                      <div className="flex items-center gap-2">
                        ...
                        <span>100+ Calgary Projects</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400" />
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-4 text-sm text-[#888888]">
                    <div className="flex items-center gap-2">
                      ...
                      <span>Local Calgary Support</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-maverick-orange" />
              ...
              <div className="container mx-auto relative z-10">
                ...
                >
                  ...
                  <p className="text-xl mb-8 text-white/90 max-w-3xl mx-auto">
                    Join the Calgary teams who ship fast, clear websites with us. Get a free consult and a clear plan.
                  </p>
                  ...
                  <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-white/80 text-sm">Calgary Support</div>
                    </div>
                  </div>
                </motion.div>
              </div>
