...
export default function WebServicesLethbridge() {
  ...
  const coreServices = [
    {
      ...
      description: "Lethbridge businesses are built tough. We build websites to match—resilient, fast, and designed to capture customers from the coulees to the north side.",
    ...
    },
    {
      ...
      description: "Sell beyond the city limits. We build Shopify stores that turn local inventory into global sales, with shipping logic that actually works.",
    ...
    },
    {
      ...
      description: "From ag-tech dashboards to booking systems, we build custom software that solves real Southern Alberta problems.",
  ...
  const specializedServices = [
    ...
    },
    {
      ...
      description: "Don't get lost in the wind. We map your site to the keywords Lethbridge locals actually search for.",
  ...
  const faqItems = [
    {
      ...
      answer: "We believe in fair pricing for Southern Alberta. Professional sites start at $1,200. No Calgary markup, just honest work."
    },
    {
      question: "Do you understand the local market?",
      answer: "Yes. Lethbridge is unique—a mix of agriculture, education, and industry. We build sites that respect that diversity and speak to your specific audience."
    },
    {
      question: "Why shouldn't I just use Wix or Squarespace?",
      answer: "You can, but they're like a flimsy fence in a chinook. If you want a site that lasts and performs, you need custom code that you own."
    },
    {
      question: "How do I rank higher than my competitors?",
      answer: "By being hyper-local. We use specific schema to tell Google you serve Lethbridge and the surrounding county. We help you own your backyard."
    },
    {
      question: "Can you fix my existing slow website?",
      answer: "Yes. We'll audit it. If it's slow, it's costing you sales. We'll optimize it to load instantly, even on mobile data."
    },
    {
      question: "What's your support like after launch?",
      answer: "We don't just build and run. We offer monthly care plans to keep your site secure, updated, and running smooth."
    }
  ];
  ...
  return (
    <div>
      <SEOHead
        title="Lethbridge Web Design | Built to Last"
        description="Websites as resilient as the city itself. We build custom, high-performance sites for Lethbridge businesses. Get a free quote."
        ...
        ogTitle="Lethbridge Web Design | Built to Last"
        ogDescription="Websites as resilient as the city itself. We build custom, high-performance sites for Lethbridge businesses. Get a free quote."
            ...
            <div className="container mx-auto px-0 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 relative z-10">
              ...
              <div className="block lg:hidden relative min-h-[calc(100svh-7rem)] flex flex-col justify-start pt-8 pb-[360px] sm:pb-[440px] md:pb-[620px]">
                <div className="relative z-10 px-0">
                  ...
                  >
                    Lethbridge is a city of builders. Your website should reflect that grit. We build digital tools that stand the test of time.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
