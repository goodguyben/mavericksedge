...
export default function WebServicesLeduc() {
  ...
  const coreServices = [
    {
      ...
      description: "Leduc is the gateway to the north. We build websites that act as your digital terminal—efficient, clear, and always open for business.",
    ...
    },
    {
      ...
      description: "Whether you're in Nisku or downtown Leduc, we build online stores that move inventory faster than a cargo jet at YEG.",
    ...
    },
    {
      ...
      description: "Logistics, tracking, and management tools. We build custom software that keeps your operations running on schedule.",
  ...
  const specializedServices = [
    ...
    },
    {
      ...
      description: "Get found by the companies that matter. We map your site to the industrial and commercial keywords that drive Leduc's economy.",
  ...
  const faqItems = [
    {
      ...
      answer: "We keep our pricing grounded. Professional sites start at $1,200. We deliver big-city quality without the downtown Edmonton price tag."
    },
    {
      question: "Do you work with Nisku businesses?",
      answer: "Yes. We understand the industrial sector. We know your clients care about specs, safety, and reliability, not fluff. We build sites that reflect that."
    },
    {
      question: "Why shouldn't I just use Wix or Squarespace?",
      answer: "Because you need reliability. DIY builders are like renting a truck that might break down. We build custom sites that you own and control."
    },
    {
      question: "How do I rank higher than my competitors?",
      answer: "By proving you're the local expert. We use specific schema to tell Google you serve Leduc, Nisku, and the airport region. Own your territory."
    },
    {
      question: "Can you fix my existing slow website?",
      answer: "Yes. Speed is critical. We'll audit your site and optimize it to load fast, ensuring you don't lose customers to a slow connection."
    },
    {
      question: "What's your support like after launch?",
      answer: "We're always on call. We offer monthly care plans to ensure your site stays secure and updated, so you can focus on moving your business forward."
    }
  ];
  ...
  return (
    <div>
      <SEOHead
        title="Leduc Web Design | Moving Business Forward"
        description="Websites that work as hard as the Nisku industrial park. We build custom, fast, and reliable sites for Leduc businesses. Get a free quote."
        ...
        ogTitle="Leduc Web Design | Moving Business Forward"
        ogDescription="Websites that work as hard as the Nisku industrial park. We build custom, fast, and reliable sites for Leduc businesses. Get a free quote."
            ...
            <div className="container mx-auto px-0 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 relative z-10">
              ...
              <div className="block lg:hidden relative min-h-[calc(100svh-7rem)] flex flex-col justify-start pt-8 pb-[360px] sm:pb-[440px] md:pb-[620px]">
                <div className="relative z-10 px-0">
                  ...
                  >
                    Leduc keeps Alberta moving. Your website should keep your business moving. We build digital tools that drive real growth.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
