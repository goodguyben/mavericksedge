...
import WebServicesCascadeSection from "@/components/sections/WebServicesCascadeSectionBeaumont";
import ScrollFadeSection from '@/components/ui/scroll-fade-section';
import { LazySection } from '@/components/performance/LazySection';
import GoogleReviews from '@/components/GoogleReviewsBeaumont';
...
export default function WebServicesBeaumont() {
  ...
  const coreServices = [
    {
      ...
      description: "Beaumont is growing fast. Your website needs to keep up. We build sites that capture the 'small town feel' while driving big city results.",
    ...
    },
    {
      ...
      description: "Sell to your neighbours or the world. We build Shopify stores that make it easy for locals to 'shop Beaumont' first.",
    ...
    },
    {
      ...
      description: "Streamline your operations. From booking systems for local services to custom portals, we build tools that save you time.",
  ...
  const specializedServices = [
    ...
    },
    {
      ...
      description: "Get found by families in Coloniale and Montrose. We map your site to how Beaumont actually searches.",
      technologies: ["Technical SEO", "Local Schema", "Core Web Vitals", "Beaumont Keywords"]
    },
    {
  ...
  const webAppTiles = [
    ...
    },
    {
      ...
      blurb:
        "Search‑ready from day one. Technical SEO, structured data, and Core Web Vitals tuned for real‑world devices and Beaumont search intent.",
      media: "https://mavericksedge.ca/videos/Portfolio_Video_27.webm",
      points: [
        "Beaumont‑relevant keyword mapping and titles",
  ...
  const faqItems = [
    {
      question: "How much does a website cost in Beaumont?",
      answer: "We believe in transparent pricing. A professional brochure site starts at $1,200. Full e-commerce builds start at $2,500. We offer payment plans for local startups."
    },
    {
      question: "Do you meet with clients in Beaumont?",
      answer: "Yes. We can meet at Chartier, Jef's Cafe, or your place of business. We believe in building relationships, not just websites."
    },
    {
      question: "Why shouldn't I just use Wix or Squarespace?",
      answer: "Those platforms are fine for hobbies. But if you want to rank in Google and own your data, you need a custom build. We create assets that grow with your business."
    },
    {
      question: "How do I rank higher than Edmonton competitors?",
      answer: "By focusing on your local advantage. We use Beaumont-specific schema and content strategies to tell Google you are the local authority. Don't compete with Edmonton; own Beaumont."
    },
    {
      question: "Can you fix my existing slow website?",
      answer: "Yes. We'll audit it for free. If we can speed it up, we will. If it needs a rebuild, we'll tell you why and give you a fair price."
    },
    {
      question: "What's your support like after launch?",
      answer: "We're not a 'launch and leave' agency. We offer monthly care plans to keep your site secure, updated, and backing up daily."
    }
  ];
  ...
  const localSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "Mavericks Edge Web Design Beaumont",
    ...
    "url": "https://mavericksedge.ca/web-design-services-beaumont",
    "sameAs": [
  ...
  return (
    <div>
      <SEOHead
        title="Beaumont Web Design | Sites That Grow With Your Business"
        description="Stand out in Beaumont's fast-growing market. We build custom, mobile-first websites that turn locals into loyal customers. Get a free quote."
        keywords="Beaumont website design, website design Beaumont, Beaumont web design, web development Beaumont, Beaumont websites"
        canonicalUrl="https://mavericksedge.ca/web-design-services-beaumont"
        ogTitle="Beaumont Web Design | Sites That Grow With Your Business"
        ogDescription="Stand out in Beaumont's fast-growing market. We build custom, mobile-first websites that turn locals into loyal customers. Get a free quote."
                ...
                <div className="relative z-10 px-0">
                  ...
                  >
                    <span className="block text-3xl sm:text-4xl md:text-5xl bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                      Beaumont Web Design & Development
                    </span>
                  ...
                  >
                    Beaumont is unique. Your website should be too. We build digital experiences that capture the local spirit and drive real business growth.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    ...
                    <div className="hidden md:flex items-center gap-6 text-sm text-[#AAAAAA]">
                      <div className="flex items-center gap-2">
                        ...
                        <span>100+ Beaumont Projects</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400" />
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-4 text-sm text-[#888888]">
                    <div className="flex items-center gap-2">
                      ...
                      <span>Local Beaumont Support</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-maverick-orange" />
                ...
                >
                  ...
                  <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-white/80 text-sm">Beaumont Support</div>
                    </div>
                  </div>
                </motion.div>
              </div>
