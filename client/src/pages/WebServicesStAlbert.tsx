...
import WebServicesCascadeSection from "@/components/sections/WebServicesCascadeSectionStAlbert";
import ScrollFadeSection from '@/components/ui/scroll-fade-section';
import { LazySection } from '@/components/performance/LazySection';
import GoogleReviews from '@/components/GoogleReviewsStAlbert';
...
export default function WebServicesStAlbert() {
  ...
  const breadcrumbs = [
    ...
    { name: "Web Development", url: "https://mavericksedge.ca/web-design-services-st-albert" }
  ];
  ...
  const webAppTiles = [
    ...
    },
    {
      ...
      blurb:
        "Search‑ready from day one. Technical SEO, structured data, and Core Web Vitals tuned for real‑world devices and St. Albert search intent.",
      media: "https://mavericksedge.ca/videos/Portfolio_Video_27.webm",
      points: [
        "St. Albert‑relevant keyword mapping and titles",
  ...
  const localSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "Mavericks Edge Web Design St. Albert",
    ...
    "url": "https://mavericksedge.ca/web-design-services-st-albert",
    "sameAs": [
                  ...
                  >
                    ...
                    <div className="hidden md:flex items-center gap-6 text-sm text-[#AAAAAA]">
                      <div className="flex items-center gap-2">
                        ...
                        <span>100+ St. Albert Projects</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400" />
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-4 text-sm text-[#888888]">
                    <div className="flex items-center gap-2">
                      ...
                      <span>Local St. Albert Support</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-maverick-orange" />
              ...
              <div className="container mx-auto relative z-10">
                ...
                >
                  ...
                  <p className="text-xl mb-8 text-white/90 max-w-3xl mx-auto">
                    Join the St. Albert teams who ship fast, clear websites with us. Get a free consult and a clear plan.
                  </p>
                  ...
                  <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-white/80 text-sm">St. Albert Support</div>
                    </div>
                  </div>
                </motion.div>
              </div>
