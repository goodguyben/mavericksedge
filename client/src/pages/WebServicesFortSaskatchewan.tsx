...
export default function WebServicesFortSaskatchewan() {
  ...
  const coreServices = [
    {
      ...
      description: "Fort Sask is more than just 'north of Edmonton'. We build sites that capture your local identity and attract customers from across the Heartland.",
    ...
    },
    {
      ...
      description: "Sell to the world from the Fort. We build Shopify stores that are easy to manage and even easier for your customers to buy from.",
    ...
    },
    {
      ...
      description: "Tools for industry and service. We build custom portals and booking systems that help Fort Sask businesses run smoother.",
  ...
  const specializedServices = [
    ...
    },
    {
      ...
      description: "Be the first choice in the Fort. We map your site to local search terms so you capture the market before they look in Edmonton.",
      technologies: ["Technical SEO", "Local Schema", "Core Web Vitals", "Fort Sask Keywords"]
    },
    {
  ...
  const faqItems = [
    {
      ...
      answer: "We keep it simple. Professional brochure sites start at $1,200. Full e-commerce builds start at $2,500. No hidden fees, just honest work."
    },
    {
      question: "Do you meet with clients in the Fort?",
      answer: "Yes. We can meet at a local coffee shop or your office. We're local to the Edmonton area and believe in face-to-face service."
    },
    {
      question: "Why shouldn't I just use Wix or Squarespace?",
      answer: "They're okay for hobbies. But if you want to grow a business in the Heartland, you need a site that Google respects. Custom code wins every time."
    },
    {
      question: "How do I rank higher than Edmonton competitors?",
      answer: "By doubling down on local. We use specific schema to tell Google you are the authority in Fort Saskatchewan. Own your backyard first."
    },
    {
      question: "Can you fix my existing slow website?",
      answer: "Yes. We'll take a look. If we can speed it up, we will. If it's too far gone, we'll give you a fair price for a rebuild."
    },
    {
      question: "What's your support like after launch?",
      answer: "We don't disappear. We offer monthly care plans to handle updates, backups, and security. We've got your back."
    }
  ];
  ...
  return (
    <div>
      <SEOHead
        title="Fort Saskatchewan Web Design | Sites That Connect"
        description="Stand out in the Heartland. We build custom, mobile-first websites for Fort Saskatchewan businesses that want to grow. Get a free quote."
        ...
        ogTitle="Fort Saskatchewan Web Design | Sites That Connect"
        ogDescription="Stand out in the Heartland. We build custom, mobile-first websites for Fort Saskatchewan businesses that want to grow. Get a free quote."
            ...
            <div className="container mx-auto px-0 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 relative z-10">
              ...
              <div className="block lg:hidden relative min-h-[calc(100svh-7rem)] flex flex-col justify-start pt-8 pb-[360px] sm:pb-[440px] md:pb-[620px]">
                <div className="relative z-10 px-0">
                  ...
                  >
                    Fort Sask is unique. Your website should be too. We build digital experiences that capture the local spirit and drive real business growth.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
