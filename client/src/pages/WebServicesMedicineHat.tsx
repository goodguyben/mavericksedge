...
import WebServicesCascadeSection from "@/components/sections/WebServicesCascadeSectionMedicineHat";
import ScrollFadeSection from '@/components/ui/scroll-fade-section';
import { LazySection } from '@/components/performance/LazySection';
import GoogleReviews from '@/components/GoogleReviewsMedicineHat';
...
export default function WebServicesMedicineHat() {
  ...
  const breadcrumbs = [
    ...
    { name: "Web Development", url: "https://mavericksedge.ca/web-design-services-medicine-hat" }
  ];
  ...
  const specializedServices = [
    ...
    },
    {
      ...
      technologies: ["Technical SEO", "Local Schema", "Core Web Vitals", "Medicine Hat Keywords"]
    },
    {
  ...
  const webAppTiles = [
    ...
    },
    {
      ...
      blurb:
        "Search‑ready from day one. Technical SEO, structured data, and Core Web Vitals tuned for real‑world devices and Medicine Hat search intent.",
      media: "https://mavericksedge.ca/videos/Portfolio_Video_27.webm",
      points: [
        "Medicine Hat‑relevant keyword mapping and titles",
  ...
  const faqItems = [
    {
      question: "How much does web design cost in Medicine Hat?",
      answer: "Our Medicine Hat web design services start at $850 for basic business websites and range up to $10,000+ for complex e-commerce and custom applications. We provide transparent pricing and free consultations to discuss your specific needs and budget."
    },
    {
      question: "How long does it take to build a website in Medicine Hat?",
      answer: "Most Medicine Hat business websites take 4-8 weeks from start to finish. Simple brochure sites can be completed in 2-3 weeks, while complex e-commerce or custom applications may take 8-12 weeks. We provide detailed timelines during our discovery phase."
    },
    {
      question: "Do you provide website hosting for Medicine Hat businesses?",
      answer: "Yes, we offer Canadian web hosting specifically optimized for Alberta businesses. Our hosting includes SSL certificates, daily backups, security monitoring, and 24/7 Medicine Hat-based support. Plans start at $25/month."
    },
    {
      question: "Can you help with SEO for my Medicine Hat business website?",
      answer: "Absolutely! All our websites include basic SEO optimization with Medicine Hat and Alberta keyword targeting. We also offer comprehensive SEO services including local optimization, Google My Business management, and ongoing search marketing."
    },
    {
      question: "Do you redesign existing websites for Medicine Hat businesses?",
    ...
    {
      question: "What makes your Medicine Hat web design different from competitors?",
      answer: "Our deep understanding of the Medicine Hat and Alberta business landscape, combined with cutting-edge design and development practices, sets us apart. We focus on local SEO, mobile optimization, and conversion-driven design that gets results."
    }
  ];
  ...
  const localSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "Mavericks Edge Web Design Medicine Hat",
    ...
    "url": "https://mavericksedge.ca/web-design-services-medicine-hat",
    "sameAs": [
  ...
  return (
    <div>
      <SEOHead 
        title="Mavericks Edge | Medicine Hat Web Design and Development"
        description="Professional Medicine Hat web design and development. Build responsive, SEO-optimized websites that drive results and help your business grow. Free quote today!"
        keywords="Medicine Hat website design, website design Medicine Hat, Medicine Hat web design, web development Medicine Hat, Medicine Hat websites"
        canonicalUrl="https://mavericksedge.ca/web-design-services-medicine-hat"
        ogTitle="Mavericks Edge | Medicine Hat Web Design and Development"
        ogDescription="Affordable Medicine Hat web design and development for businesses that want to stand out online. Fast, responsive, and SEO-optimized websites that convert visitors into customers."
                ...
                <div className="relative z-10 px-0">
                  ...
                  >
                    <span className="block text-3xl sm:text-4xl md:text-5xl bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                      Medicine Hat Web Design & Development
                    </span>
                  ...
                  >
                    ...
                    <div className="hidden md:flex items-center gap-6 text-sm text-[#AAAAAA]">
                      <div className="flex items-center gap-2">
                        ...
                        <span>100+ Medicine Hat Projects</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400" />
              ...
              <div className="container mx-auto">
                ...
                >
                  <h2 className="text-4xl md:text-5xl font-bold mb-6 font-heading">
                    Medicine Hat Website Design FAQ
                  </h2>
                  <p className="text-[#AAAAAA] text-xl max-w-3xl mx-auto">
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-4 text-sm text-[#888888]">
                    <div className="flex items-center gap-2">
                      ...
                      <span>Local Medicine Hat Support</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-maverick-orange" />
              ...
              <div className="container mx-auto relative z-10">
                ...
                >
                  ...
                  <p className="text-xl mb-8 text-white/90 max-w-3xl mx-auto">
                    Join the Medicine Hat teams who ship fast, clear websites with us. Get a free consult and a clear plan.
                  </p>
                  ...
                  <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-white/80 text-sm">Medicine Hat Support</div>
                    </div>
                  </div>
                </motion.div>
              </div>
