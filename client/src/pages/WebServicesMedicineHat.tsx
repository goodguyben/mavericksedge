...
export default function WebServicesMedicineHat() {
  ...
  const coreServices = [
    {
      ...
      description: "Medicine Hat is the sunniest city in Canada. We build bright, clean websites that put your business in the best light.",
    ...
    },
    {
      ...
      description: "Sell to the world from the Gas City. We build Shopify stores that handle inventory, shipping, and payments without the headache.",
    ...
    },
    {
      ...
      description: "Automate your operations. From energy sector dashboards to local booking systems, we build software that saves you time.",
  ...
  const specializedServices = [
    ...
    },
    {
      ...
      description: "Own the search results in Southeast Alberta. We map your site to the keywords Medicine Hat locals actually use.",
  ...
  const faqItems = [
    {
      ...
      answer: "We keep it real. Professional sites start at $1,200. You get a high-performance asset without the big agency bloat."
    },
    {
      question: "Do you understand the local market?",
      answer: "Yes. Medicine Hat isn't just a stop on the highway. It's a hub for energy, agriculture, and retail. We build sites that speak to your specific customers."
    },
    {
      question: "Why shouldn't I just use Wix or Squarespace?",
      answer: "Because you want to grow. DIY builders are fine for a hobby, but if you're running a real business, you need a site that you own and control."
    },
    {
      question: "How do I rank higher than my competitors?",
      answer: "By being specific. We use local schema to tell Google you serve Medicine Hat, Redcliff, and Dunmore. We help you own your corner of the province."
    },
    {
      question: "Can you fix my existing slow website?",
      answer: "Yes. A slow site is a broken site. We'll audit it and make the necessary changes to get it loading instantly."
    },
    {
      question: "What's your support like after launch?",
      answer: "We're here for the long haul. We offer monthly care plans to keep your site secure, backed up, and up to date."
    }
  ];
  ...
  return (
    <div>
      <SEOHead
        title="Medicine Hat Web Design | Fuel For Your Business"
        description="Websites that work as hard as the Gas City. We build custom, high-performance sites for Medicine Hat businesses. Get a free quote."
        ...
        ogTitle="Medicine Hat Web Design | Fuel For Your Business"
        ogDescription="Websites that work as hard as the Gas City. We build custom, high-performance sites for Medicine Hat businesses. Get a free quote."
            ...
            <div className="container mx-auto px-0 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 relative z-10">
              ...
              <div className="block lg:hidden relative min-h-[calc(100svh-7rem)] flex flex-col justify-start pt-8 pb-[360px] sm:pb-[440px] md:pb-[620px]">
                <div className="relative z-10 px-0">
                  ...
                  >
                    Medicine Hat has the energy. Your website should too. We build digital tools that drive real business growth.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
