...
export default function WebServicesSpruceGrove() {
  ...
  const coreServices = [
    {
      ...
      description: "Spruce Grove is growing fast. Your business needs to keep up. We build scalable websites that handle the traffic and convert the locals.",
    ...
    },
    {
      ...
      description: "Sell beyond Highway 16. We build Shopify stores that turn local inventory into global sales, with shipping logic that makes sense.",
    ...
    },
    {
      ...
      description: "Automate the busywork. From scheduling systems to customer portals, we build software that lets you focus on growing your business.",
  ...
  const specializedServices = [
    ...
    },
    {
      ...
      description: "Don't get lost in the Edmonton noise. We map your site to the keywords Spruce Grove locals actually search for.",
  ...
  const faqItems = [
    {
      ...
      answer: "We believe in fair value. Professional sites start at $1,200. No hidden fees, just a solid investment in your growth."
    },
    {
      question: "Do you understand the local market?",
      answer: "Yes. Spruce Grove is a mix of young families and established businesses. We build sites that appeal to that dynamic demographic."
    },
    {
      question: "Why shouldn't I just use Wix or Squarespace?",
      answer: "You can, but you'll hit a ceiling. If you want a site that scales with your business and ranks on Google, you need custom code."
    },
    {
      question: "How do I rank higher than my competitors?",
      answer: "By being hyper-local. We use specific schema to tell Google you serve Spruce Grove, Stony Plain, and Parkland County. We help you own your backyard."
    },
    {
      question: "Can you fix my existing slow website?",
      answer: "Yes. We'll audit it. If it's slow, it's costing you leads. We'll optimize it to load instantly, even on mobile data."
    },
    {
      question: "What's your support like after launch?",
      answer: "We don't disappear. We offer monthly care plans to keep your site secure, updated, and running smooth."
    }
  ];
  ...
  return (
    <div>
      <SEOHead
        title="Spruce Grove Web Design | Growth Without Growing Pains"
        description="Websites that scale with your business. We build custom, high-performance sites for Spruce Grove businesses. Get a free quote."
        ...
        ogTitle="Spruce Grove Web Design | Growth Without Growing Pains"
        ogDescription="Websites that scale with your business. We build custom, high-performance sites for Spruce Grove businesses. Get a free quote."
            ...
            <div className="container mx-auto px-0 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 relative z-10">
              ...
              <div className="block lg:hidden relative min-h-[calc(100svh-7rem)] flex flex-col justify-start pt-8 pb-[360px] sm:pb-[440px] md:pb-[620px]">
                <div className="relative z-10 px-0">
                  ...
                  >
                    Spruce Grove is moving fast. Your website should too. We build digital tools that help you keep up and get ahead.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
