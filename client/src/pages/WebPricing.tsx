...
export default function WebPricing() {
  ...
  return (
    <>
      <SEOHead
        title="Web Design Pricing | Edmonton Website Packages | Mavericks Edge"
        description="Clear web design pricing for Edmonton businesses. Compare packages and features for professional websites optimized for speed, SEO, and conversions."
        canonicalUrl="https://mavericksedge.ca/web-design-pricing-edmonton"
      />
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
