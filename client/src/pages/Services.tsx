          ...
          {serviceCategories.map((category, index) => (
            ...
            >
              <div className={index % 2 === 1 ? 'order-1 lg:order-2' : ''}>
                ...
                <Link href={category.linkHref} className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-maverick-orange hover:bg-maverick-orange/90 transition-all duration-200 maverick-button-primary">
