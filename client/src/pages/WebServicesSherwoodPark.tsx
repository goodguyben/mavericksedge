...
export default function WebServicesSherwoodPark() {
  ...
  const coreServices = [
    {
      ...
      description: "Sherwood Park isn't just a bedroom community. It's a business hub. We build sites that reflect that professionalism and drive local growth.",
    ...
    },
    {
      ...
      description: "Expand your reach beyond the Park. We build Shopify stores that turn local inventory into global sales, 24/7.",
    ...
    },
    {
      ...
      description: "Streamline your operations. From industrial tracking to service booking, we build custom software that solves real problems.",
  ...
  const specializedServices = [
    ...
    },
    {
      ...
      description: "Get found by your neighbors. We map your site to the keywords Sherwood Park locals actually use when they need your services.",
  ...
  const faqItems = [
    {
      ...
      answer: "We offer premium quality without the premium price tag. Professional sites start at $1,200. Honest pricing for honest work."
    },
    {
      question: "Do you understand the local market?",
      answer: "Yes. We know Sherwood Park is unique. It's affluent, family-oriented, and industrial. We build sites that speak to that specific mix."
    },
    {
      question: "Why shouldn't I just use Wix or Squarespace?",
      answer: "Because you want to stand out. Templates look like everyone else. We build custom sites that reflect your unique brand and value."
    },
    {
      question: "How do I rank higher than my competitors?",
      answer: "By being specific. We use local schema to tell Google you serve Sherwood Park and Strathcona County, not just 'Edmonton area'."
    },
    {
      question: "Can you fix my existing slow website?",
      answer: "Yes. Speed kills conversions. We'll audit your site and optimize it to load fast, keeping your customers engaged."
    },
    {
      question: "What's your support like after launch?",
      answer: "We're your digital partners. We offer monthly care plans to keep your site secure, updated, and performing at its best."
    }
  ];
  ...
  return (
    <div>
      <SEOHead
        title="Sherwood Park Web Design | Refining Your Digital Presence"
        description="Websites that work as hard as Refinery Row. We build custom, high-performance sites for Sherwood Park businesses. Get a free quote."
        ...
        ogTitle="Sherwood Park Web Design | Refining Your Digital Presence"
        ogDescription="Websites that work as hard as Refinery Row. We build custom, high-performance sites for Sherwood Park businesses. Get a free quote."
            ...
            <div className="container mx-auto px-0 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 relative z-10">
              ...
              <div className="block lg:hidden relative min-h-[calc(100svh-7rem)] flex flex-col justify-start pt-8 pb-[360px] sm:pb-[440px] md:pb-[620px]">
                <div className="relative z-10 px-0">
                  ...
                  >
                    Sherwood Park demands quality. Your website should deliver it. We build digital tools that drive real business growth.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
