...
export default function WebServicesGrandePrairie() {
  ...
  const coreServices = [
    {
      ...
      description: "In the Peace Country, you need a website that works as hard as you do. We build sites that connect you to customers from Beaverlodge to Clairmont.",
    ...
    },
    {
      ...
      description: "Expand your reach beyond Highway 43. We build Shopify stores that let you sell your products to the world, 24/7.",
    ...
    },
    {
      ...
      description: "Automate your business. From dispatch systems to client portals, we build custom software that saves you time and money.",
  ...
  const specializedServices = [
    ...
    },
    {
      ...
      description: "Dominate the Swan City search results. We map your site to the keywords Grande Prairie locals actually use.",
      technologies: ["Technical SEO", "Local Schema", "Core Web Vitals", "GP Keywords"]
    },
    {
  ...
  const faqItems = [
    {
      ...
      answer: "We don't charge a 'northern premium'. Our professional sites start at $1,200. You get big city quality at a fair, honest price."
    },
    {
      question: "Do you understand the local market?",
      answer: "Yes. We know Grande Prairie is unique. It's a hub for industry, agriculture, and retail. We build sites that speak to that diverse audience."
    },
    {
      question: "Why shouldn't I just use Wix or Squarespace?",
      answer: "Because you want to own your success. Those platforms are rented land. We build custom sites that you own, giving you control and better SEO."
    },
    {
      question: "How do I rank higher than my competitors?",
      answer: "By being specific. We use local schema to tell Google you serve Grande Prairie and the Peace Country. We help you own your niche."
    },
    {
      question: "Can you fix my existing slow website?",
      answer: "Yes. A slow site loses customers. We'll audit your current site and tell you exactly how to make it fly."
    },
    {
      question: "What's your support like after launch?",
      answer: "We're in it for the long haul. We offer monthly care plans to keep your site secure, backed up, and up to date."
    }
  ];
  ...
  return (
    <div>
      <SEOHead
        title="Grande Prairie Web Design | Sites That Work Hard"
        description="Grow your business in the Peace Country. We build custom, high-performance websites for Grande Prairie companies. Get a free quote."
        ...
        ogTitle="Grande Prairie Web Design | Sites That Work Hard"
        ogDescription="Grow your business in the Peace Country. We build custom, high-performance websites for Grande Prairie companies. Get a free quote."
            ...
            <div className="container mx-auto px-0 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 relative z-10">
              ...
              <div className="block lg:hidden relative min-h-[calc(100svh-7rem)] flex flex-col justify-start pt-8 pb-[360px] sm:pb-[440px] md:pb-[620px]">
                <div className="relative z-10 px-0">
                  ...
                  >
                    Grande Prairie is the engine of the north. Your website should be too. We build digital tools that drive real business growth.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
