...
export default function WebServicesStonyPlain() {
  ...
  const coreServices = [
    {
      ...
      description: "Stony Plain honors its past but builds for the future. We create websites that respect your brand's history while driving modern growth.",
    ...
    },
    {
      ...
      description: "Main Street service, online reach. We build Shopify stores that let you sell to the world without losing that local touch.",
    ...
    },
    {
      ...
      description: "Modernize your operations. We build custom software that handles the heavy lifting, so you can focus on your customers.",
  ...
  const specializedServices = [
    ...
    },
    {
      ...
      description: "Get found by the locals. We map your site to the keywords Stony Plain residents use when they need your help.",
  ...
  const faqItems = [
    {
      ...
      answer: "We offer fair, transparent pricing. Professional sites start at $1,200. You get a premium asset without the big city markup."
    },
    {
      question: "Do you understand the local market?",
      answer: "Yes. Stony Plain is unique. It's about community and trust. We build sites that reflect those values and help you connect."
    },
    {
      question: "Why shouldn't I just use Wix or Squarespace?",
      answer: "Because you want to own your growth. Templates are limited. We build custom sites that scale with your business and your ambition."
    },
    {
      question: "How do I rank higher than my competitors?",
      answer: "By being specific. We use local schema to tell Google you serve Stony Plain and Parkland County. We help you own your local niche."
    },
    {
      question: "Can you fix my existing slow website?",
      answer: "Yes. A slow site loses customers. We'll audit your site and optimize it to load fast, keeping your visitors happy."
    },
    {
      question: "What's your support like after launch?",
      answer: "We stick around. We offer monthly care plans to keep your site secure, updated, and working hard for your business."
    }
  ];
  ...
  return (
    <div>
      <SEOHead
        title="Stony Plain Web Design | Modern Business, Traditional Values"
        description="Websites that honor your history and drive your future. We build custom, high-performance sites for Stony Plain businesses. Get a free quote."
        ...
        ogTitle="Stony Plain Web Design | Modern Business, Traditional Values"
        ogDescription="Websites that honor your history and drive your future. We build custom, high-performance sites for Stony Plain businesses. Get a free quote."
            ...
            <div className="container mx-auto px-0 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 relative z-10">
              ...
              <div className="block lg:hidden relative min-h-[calc(100svh-7rem)] flex flex-col justify-start pt-8 pb-[360px] sm:pb-[440px] md:pb-[620px]">
                <div className="relative z-10 px-0">
                  ...
                  >
                    Stony Plain values quality and trust. Your website should too. We build digital tools that help you connect and grow.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
