...
export default function WebServicesFortMcMurray() {
  ...
  const coreServices = [
    {
      ...
      title: "Industrial-Grade Web Design",
      description: "In Fort Mac, reliability is everything. We build websites that work as hard as you do. No downtime, no excuses, just results.",
    ...
    },
    {
      ...
      description: "Whether you're selling safety gear or local goods, we build Shopify stores that handle the volume and keep the orders flowing.",
    ...
    },
    {
      ...
      description: "Streamline your operations. We build custom safety portals, booking systems, and field data tools for the industrial sector.",
  ...
  const specializedServices = [
    ...
    },
    {
      ...
      description: "Get found by the big players. We map your site to how Fort McMurray industry actually searches.",
  ...
  const faqItems = [
    {
      ...
      answer: "We know the Fort Mac markup exists. We don't charge it. Our professional sites start at $1,200. Fair pricing for hard work."
    },
    {
      question: "Do you understand the industrial sector?",
      answer: "Yes. We know safety, compliance, and reliability are non-negotiable. We build sites that reflect that professionalism."
    },
    {
      question: "Why shouldn't I just use Wix or Squarespace?",
      answer: "You can, but they break. If you want a site that's as reliable as your best truck, you need custom code. We build assets you own."
    },
    {
      question: "How do I rank higher than my competitors?",
      answer: "By proving you're the local authority. We use specific schema markup to tell Google you serve the Wood Buffalo region, not just 'Alberta'."
    },
    {
      question: "Can you fix my existing slow website?",
      answer: "Yes. We'll audit it. If it's slow, it's costing you contracts. We'll optimize it or rebuild it to load instantly."
    },
    {
      question: "What's your support like after launch?",
      answer: "We're here for the long haul. We offer monthly care plans to keep your site secure and updated. You focus on the job; we handle the web."
    }
  ];
  ...
  return (
    <div>
      <SEOHead
        title="Fort McMurray Web Design | Industrial Strength Sites"
        description="Reliable, high-performance websites for Fort McMurray businesses. We build digital tools that work as hard as you do. Get a free quote."
        ...
        ogTitle="Fort McMurray Web Design | Industrial Strength Sites"
        ogDescription="Reliable, high-performance websites for Fort McMurray businesses. We build digital tools that work as hard as you do. Get a free quote."
            ...
            <div className="container mx-auto px-0 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 relative z-10">
              ...
              <div className="block lg:hidden relative min-h-[calc(100svh-7rem)] flex flex-col justify-start pt-8 pb-[360px] sm:pb-[440px] md:pb-[620px]">
                <div className="relative z-10 px-0">
                  ...
                  >
                    In Fort Mac, reputation is everything. We build websites that prove you're the reliable choice for the job.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
