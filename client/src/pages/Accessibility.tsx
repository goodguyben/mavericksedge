              ...
              <div className="space-y-12">
                ...
                <section>
                  ...
                  <div className="text-gray-300 space-y-4">
                    ...
                    <div className="bg-gray-800/50 p-6 rounded-lg">
                      <p><strong>Accessibility Coordinator:</strong> <a href="mailto:accessibility@mavericksedge.com" className="text-maverick-orange hover:underline">accessibility@mavericksedge.com</a></p>
                      <p><strong>General Contact:</strong> <a href="mailto:info@mavericksedge.com" className="text-maverick-orange hover:underline">info@mavericksedge.com</a></p>
