      ...
      (item: LogoItem, key: React.Key) => {
        ...
        const content = isNodeItem ? (
          <span
            ...
            aria-hidden={(item as any).href ? true : undefined}
          >
            {(item as any).node}
          </span>
        ) : (
        ...
        return (
          ...
          >
            <div className="flex flex-col items-center">
              {inner}
              {displayTitle && (
                <div className="mt-2 h-4 text-xs text-[#AAAAAA] text-center opacity-0 group-hover/item:opacity-100 transition-opacity duration-200 whitespace-nowrap">
                  {displayTitle}
                </div>
              )}
            </div>
