...
const testimonials = [
  ...
  },
  {
    ...
    imgSrc: "https://images.unsplash.com/photo-1507591064344-4c6ce005b128?w=150&h=150&fit=crop&crop=faces"
  },
  {
    tempId: 8,
    testimonial: "It's just the best. Period.",
    by: "Fernando, UX Designer at UserFirst",
    imgSrc: "https://images.unsplash.com/photo-1506277886164-e25aa3f4ef7f?w=150&h=150&fit=crop&crop=faces"
  },
  {
    tempId: 9,
    testimonial: "I switched 5 years ago and never looked back.",
    by: "Andy, DevOps Engineer at CloudMasters",
    imgSrc: "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=150&h=150&fit=crop&crop=faces"
  },
  {
    tempId: 10,
  ...
  },
  {
    ...
    imgSrc: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=150&h=150&fit=crop&crop=faces"
  },
  {
    tempId: 13,
  ...
  },
  {
    ...
    imgSrc: "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=150&h=150&fit=crop&crop=faces"
  },
  {
    tempId: 15,
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isCenter 
          ? "z-10 bg-neutral-100 text-neutral-900 border-neutral-200" 
          : "z-0 bg-neutral-900 text-neutral-100 border-neutral-700 hover:border-neutral-500"
      )}
      style={{
        width: cardSize,
        height: cardSize,
        ...
        `,
        boxShadow: isCenter ? "0px 10px 0px 3px rgba(255,255,255,0.15)" : "0px 0px 0px 0px transparent"
      }}
    >
      <span
        className="absolute block origin-top-right rotate-45 bg-neutral-600"
        style={{
          right: -2,
          top: 48,
          width: SQRT_5000,
      ...
      <h3 className={cn(
        ...
        isCenter ? "text-neutral-900" : "text-neutral-100"
      )}>
        "{testimonial.testimonial}"
      </h3>
      <p className={cn(
        "absolute bottom-8 left-8 right-8 mt-2 text-sm italic",
        isCenter ? "text-neutral-700" : "text-neutral-400"
      )}>
        - {testimonial.by}
      </p>
    </div>
      ...
      <div className="absolute bottom-4 left-1/2 flex -translate-x-1/2 gap-2">
        <button
          ...
          className={cn(
            ...
            "bg-neutral-900 text-neutral-100 border-2 border-neutral-700 hover:bg-neutral-100 hover:text-neutral-900",
