...
export const CircularTestimonials = ({
  ...
  return (
    <div className="w-full max-w-[56rem] p-8">
      <div className="relative flex gap-12 md:gap-20">
        {/* Images */}
        <div 
          className="relative w-1/3 h-96 perspective-1000 flex-shrink-0"
        ...
        {/* Content */}
        <div className="flex flex-col justify-between flex-1 pl-12">
          ...
          <div className="flex gap-6 pt-12 md:pt-0 justify-start">
            <button
