...
export default function GoogleReviewsGrandePrairie({ limit = 12 }: GoogleReviewsProps) {
  ...
  return (
    <section className="py-24 px-5 md:px-10 bg-[#1E1E1E]">
      ...
      <div className="container mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 font-heading">What Grande Prairie Businesses Say</h2>
          <p className="text-[#AAAAAA] text-xl max-w-2xl mx-auto">
            Real Google reviews from our clients in Grande Prairie.
          </p>
        </motion.div>
