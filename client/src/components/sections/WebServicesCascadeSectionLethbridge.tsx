      ...
      case "seo":
        return [
          ...
          },
          {
            ...
            description: "For Lethbridge businesses, we focus on Google Business Profile optimization and hyper-local landing pages to dominate the local map pack.",
            features: [
              "Google Business Profile complete optimization with regular posts and Q&A management",
              "Local keywords targeting 'Lethbridge,' neighborhood-specific terms, and 'near me' searches",
              "Citation building on YellowPages.ca, Lethbridge Chamber, and industry directories",
...
export default function WebServicesCascadeSectionLethbridge() {
  const services: ServiceSection[] = [
    {
      id: "web-applications",
      title: "Web Design Services for Lethbridge Businesses",
      ...
      items: [
        {
          ...
          description:
            "We design custom websites that range from clean, professional layouts to immersive 3D and interactive experiences. Each crafted to engage, captivate, and convert. Whether you're looking for a straightforward, elegant website or a dynamic, story-driven journey with scroll-triggered animations, spatial design, or product showcases, our team of expert website builders brings your vision to life with clarity and creativity. For high-quality website design Lethbridge businesses can rely on, we deliver results that make a lasting impact.",
          videos: [
      ...
      <div className="container mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            <span className="block sm:hidden">Lethbridge Web Design Services</span>
