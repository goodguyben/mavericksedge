      ...
      case "seo":
        return [
          ...
          },
          {
            ...
            description: "For Edmonton businesses, we focus on Google Business Profile optimization and hyper-local landing pages to dominate the local map pack.",
            features: [
              "Google Business Profile complete optimization with regular posts and Q&A management",
              "Local keywords targeting 'Edmonton,' neighborhood-specific terms, and 'near me' searches",
              "Citation building on YellowPages.ca, Edmonton Chamber, and industry directories",
...
export default function WebServicesCascadeSection() {
  const services: ServiceSection[] = [
    {
      id: "web-applications",
      title: "Web Design Services for Edmonton Businesses",
      ...
      <div className="container mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            <span className="block sm:hidden">Edmonton Web Design Services</span>
