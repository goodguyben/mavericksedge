      ...
      <div className="container mx-auto px-3 xs:px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 z-20 flex justify-center items-center w-full pointer-events-none">
        ...
        >
          <motion.h1 
            ...
            className="flex items-center gap-2 text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-heading font-medium text-maverick-cream/70 xs:mb-6 sm:mb-8 md:mb-10 lg:mb-12 xl:mb-14 mt-[12px] mb-[12px]"
          >
          ...
          <motion.p
            ...
            className="hero-tagline text-sm xs:text-base sm:text-lg md:text-xl lg:text-xl xl:text-2xl 2xl:text-3xl text-maverick-cream/80 xs:mt-8 sm:mt-10 md:mt-12 lg:mt-14 xl:mt-16 xs:mb-8 sm:mb-10 md:mb-12 lg:mb-14 xl:mb-16 font-sans leading-relaxed text-left pl-[12px] pr-[12px] mt-[20px] mb-[20px]"
          >
