...
import DominoAnimation from "@/components/animations/DominoAnimation";
...
export default function Hero() {
  ...
  return (
    <>
      <section ref={heroRef} className="relative min-h-screen flex items-center bg-[#121212] overflow-hidden pt-24 md:pt-32">
        ...
        <motion.div
          ...
          onClick={() => scrollToSection("domino-animation")}
        >
          <ChevronDown className="h-6 w-6 animate-bounce text-maverick-orange" />
        </motion.div>
      </section>
      
      {/* Domino Animation Section */}
      <section id="domino-animation" className="bg-[#101010]">
        <DominoAnimation />
      </section>
    </>
  );
