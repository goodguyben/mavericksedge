        ...
        >
          ...
          <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-heading font-extrabold tracking-wide leading-tight text-maverick-cream text-left">
            <motion.div 
              ...
              className="block"
            >
              <span className="text-maverick-cream block font-extrabold text-[56px]">Building resilient online presence from</span>
          ...
          <motion.p
            ...
            className="hero-tagline text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl text-maverick-cream/80 sm:mt-6 md:mt-8 lg:mt-10 xl:mt-12 2xl:mt-14 sm:mb-6 md:mb-8 lg:mb-10 xl:mb-12 2xl:mb-14 font-sans leading-relaxed text-left mt-[24px] mb-[24px]"
          >
