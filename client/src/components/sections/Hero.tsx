      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 z-20 flex justify-start items-center w-full pointer-events-none relative">
        ...
        >
          ...
          <motion.p
            ...
            className="hero-tagline text-sm sm:text-base md:text-lg lg:text-lg xl:text-xl 2xl:text-2xl text-maverick-cream/80 mt-4 sm:mt-4 md:mt-5 lg:mt-6 xl:mt-7 2xl:mt-8 mb-6 sm:mb-6 md:mb-8 lg:mb-10 xl:mb-12 2xl:mb-14 font-sans leading-relaxed text-left"
          >
