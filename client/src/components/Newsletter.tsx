            ...
            >
              <div className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
                ...
                <motion.button
                  type="submit"
                  disabled={isSubmitting}
                  className={`px-6 py-3 bg-maverick-orange text-white rounded-lg flex items-center justify-center hover:bg-maverick-orange/90 whitespace-nowrap maverick-button-primary subscribe-button ${
