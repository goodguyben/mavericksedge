    ...
    >
      <div className="container mx-auto flex justify-between items-center">
        <Link href="/" className="flex items-center ml-[-29px] mr-[-29px]" aria-label="Mavericks Edge Home">
          ...
          <h1 className="font-heading sm:text-4xl md:text-5xl text-maverick-orange whitespace-nowrap mt-[15px] mb-[15px] ml-[-8px] mr-[-8px] pl-[0px] pr-[0px] font-bold text-[38px]" style={{ letterSpacing: '0' }}>
            Mavericks Edge
          </h1>
        </Link>
