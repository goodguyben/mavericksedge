...
export default function Header() {
  ...
  return (
    <motion.header 
      className="fixed top-0 left-0 w-full py-3 sm:py-4 md:py-6 px-3 sm:px-4 md:px-10 z-50 transition-all duration-300 bg-[#0000004a]" 
      role="banner"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ 
    ...
    >
      <div className="container mx-auto flex justify-between items-center">
        <Link href="/" className="flex items-center ml-[-29px] mr-[-29px]" aria-label="Mavericks Edge Home">
          ...
          <h1 className="font-heading font-bold sm:text-4xl md:text-5xl text-maverick-orange whitespace-nowrap mt-[15px] mb-[15px] ml-[-8px] mr-[-8px] pl-[0px] pr-[0px] text-[36px]" style={{ letterSpacing: '0' }}>
            Mavericks Edge
          </h1>
        </Link>
        ...
        <button
          onClick={toggleMenu}
          className="block md:hidden focus:outline-none z-50 p-2 rounded-full backdrop-blur-sm ml-[-24px] mr-[-24px] bg-[#3d445c00]"
