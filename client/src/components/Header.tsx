              ...
              >
                ...
                <div className="w-full text-center border-b border-maverick-slate/20 py-3">
                  <div 
                    ...
                    className="cursor-pointer inline-flex items-center justify-center hover-link py-3 w-full text-center text-lg text-white hover:text-maverick-orange pl-4"
                  >
                    Services
