  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center overflow-hidden">
      <div className="text-center mb-8 absolute top-8 z-10">
        <h1 className="text-2xl md:text-4xl font-bold">Animal Gallery</h1>
        <p className="text-sm md:text-base text-muted-foreground">Auto-rotating 3D gallery</p>
      </div>
      <div className="w-full h-full">
        <CircularGallery items={galleryData} radius={400} autoRotateSpeed={0.08} />
      </div>
    </div>
  );
};
